...
from echoai.cli.mcp.mcp_hub import McpHub
...
from echoai.cli.tools.mcp_tool import UseMcpTool
...
if __name__ == "__main__":
    ...
    """
利用google搜索MCP相关文档，并保存到当前目录下的mcp_document.md中，我想要查询的文档内容是如何编写mcp服务，在你详细了解如何创建服务后再编写文档，你可以多次搜索和访问网页。你应该尽可能通过官方网站和文档来获取信息。并在获取信息后，继续搜索相关内容，以获得更加完整且详细的文档，包括详细的概念介绍、解释以及对应的示例代码，文档应该尽可能详细，最后再将其保存到mcp_document.md中。在整个过程中请你使用一个单独的文件存放待办事项。
    """
