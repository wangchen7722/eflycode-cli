...
class TestAgentMemory(unittest.TestCase):
    ...
    def test_search_memory(self):
        # 添加测试数据
        self.memory.store_memory("Python编程", MemoryType.SHORT_TERM)
        self.memory.store_memory("机器学习", MemoryType.LONG_TERM)
    ...
    def test_clear_memory(self):
        # 添加测试数据
        self.memory.store_memory("短期记忆", MemoryType.SHORT_TERM)
        self.memory.store_memory("长期记忆", MemoryType.LONG_TERM)
    ...
    def test_get_memory_by_id(self):
        # 添加测试数据
        memory_item = self.memory.store_memory("测试记忆", MemoryType.SHORT_TERM)
    ...
    def test_get_recent_memories(self):
        # 添加测试数据
        self.memory.store_memory("记忆1", MemoryType.SHORT_TERM)
        self.memory.store_memory("记忆2", MemoryType.LONG_TERM)
        self.memory.store_memory("记忆3", MemoryType.SHORT_TERM)
