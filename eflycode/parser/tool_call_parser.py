...
from eflycode.schema.llm import ChatCompletionChunk, DeltaToolCallFunction, StreamChoice, ToolCall, DeltaToolCall, \
    ToolDefinition, ToolFunction, Message, DeltaMessage, \
    ToolCallFunction, ChatCompletion
from eflycode.parser.base_parser import ChatCompletionStreamParser, ChatCompletionParser
